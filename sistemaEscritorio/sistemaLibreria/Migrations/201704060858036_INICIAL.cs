namespace sistemaLibreria.Migrations
{
    using System;
                ...
                c => new
                    {
                        ...
                        sNombreCompleto = c.String(nullable: false, maxLength: 60, storeType: "nvarchar"),
                        ...
                        sCorreoElectronico = c.String(nullable: false, maxLength: 40, storeType: "nvarchar"),
                        sCurp = c.String(nullable: false, maxLength: 20, storeType: "nvarchar"),
                        sNivelEstudios = c.String(nullable: false, maxLength: 20, storeType: "nvarchar"),
                ...
                c => new
                    {
                        ...
                        sNombre = c.String(nullable: false, maxLength: 40, storeType: "nvarchar"),
                ...
                c => new
                    {
                        ...
                        sPassword = c.String(nullable: false, maxLength: 100, storeType: "nvarchar"),
                        bStatus = c.Boolean(nullable: false),
                ...
                c => new
                    {
                        ...
                        sModulo = c.String(nullable: false, maxLength: 40, storeType: "nvarchar"),
                        sDescripcion = c.String(nullable: false, maxLength: 150, storeType: "nvarchar"),
                        bStatus = c.Boolean(nullable: false),
                    })
